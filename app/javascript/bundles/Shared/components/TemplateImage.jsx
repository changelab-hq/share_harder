...
class TemplateImage extends React.Component {
  ...
  hideUrl(e) {
    ...
    this.props.dispatches.updateTemplateImage({url: e.target.value})
  }
      ...
      <div className="template-image">
        <div>
          <div style={{width: width, height: height, position: 'relative'}} className='contains-hover'>
            <IconButton aria-label="Add overlay" onClick={addOverlay} className='overlay-icon show-on-hover' style={styles.overlay_icon}>
            ...
            >
              <img src={url} onBlur={this.props.onBlur} style={{width: '100%', height: '100%'}} onClick={this.showUrl.bind(this)} onBlur={this.hideUrl.bind(this)} />
